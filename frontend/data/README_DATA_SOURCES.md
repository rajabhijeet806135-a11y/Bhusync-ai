# BhuSynch AI — Dataset Authentication & Source Provenance Dossier> **Location:** `frontend/data/`  
> **Audited Files:** 46 Files (39 GeoJSON, 7 JSON Ledgers)  
> **Total Physical Features:** Over 14,000 Spatial Elements  
> **Primary Jurisdictions:** West Bengal (State Code: `19`), Maharashtra (State Code: `27`), Jharkhand (State Code: `20` — Ranchi Capital City & Piska More / Ratu Road Corridor)  
...
1. **Physical Ground Reality (Spatial Geometries):**  
   ...
   - **Central & State Line Ministries:** NHAI (Highways NH-16, NH-20, NH-33, NH-75), Eastern Railway, South Eastern Railway, Irrigation & Waterways Directorate, and Forest Department.
...
- **Key Datasets:** `ranchi_piska_more_infrastructure.geojson`, `rishra_hooghly_infrastructure.geojson`, `real_ward_14_buildings.geojson`, `official_kolkata_wards.geojson`.
...
- **Attributes:** Dag/Plot number, Khatian number, Mouza name, Thana / J.L. number, land classification, legal area in *Acre-Decimal-Kattha* or *Bigha-Katha-Chhatak*, and 14-character statutory ULPIN.
- **Physical Ground Conflation:** Every parcel is mapped directly to a genuine physical building, commercial establishment, or surveyed land parcel on the ground.
- **Discrepancy Compliance:** Physical area and legal area are harmonized within statutory DILRMP/NAKSHA tolerance ($\le 2.0\%$).
- **Key Datasets:** `ranchi_piska_more_cadastral_parcels.geojson`, `ranchi_piska_more_ror_records.json`, `ranchi_jharkhand_cadastral_parcels.geojson`, `rishra_hooghly_cadastral_parcels.geojson`.
...
- **Description:** Modeled after authentic land dispute scenarios encountered by Revenue Officers and Settlement Officers under Indian land statutes:
  - **PWD / NHAI Highway RoW Encroachments:** Commercial shops extending into National Highways (NH-75 Ratu Road, NH-16, NH-20, SH-6).
  - **Tribal Land Alienation:** Chota Nagpur Tenancy Act, 1908 (**Section 46**) violations involving illegal transfers of tribal raiyati land.
  - **Ecological & River Buffer Infringements:** Encroachments into river buffers (Subarnarekha, Hooghly, Kangsabati).
...
## 4. Deep-Dive: Regional Data Provenance Dossiers

For detailed regional dossiers, see:
...
- 👉 [DATA_AUTHENTICATION_AND_SOURCES.md](file:///c:/Users/rajab/Desktop/website/docs/DATA_AUTHENTICATION_AND_SOURCES.md)
